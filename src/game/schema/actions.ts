...
export const ACTION_TYPES = [
  ...
  'RUN_PAUSE_SET', 'RUN_CONTINUED_AFTER_UNICORN', 'RUN_ABANDONED', 'FOUNDER_FUNCTION_ENTERED',
  ...
  'QUARTER_RESULTS_REVIEWED', 'QUARTER_RELIC_CHOSEN', 'QUARTER_RELICS_SKIPPED', 'QUARTER_STRATEGY_CHOSEN', 'QUARTER_STRATEGY_SKIPPED', 'QUARTER_INVESTING_FINISHED', 'QUARTER_NEXT_STARTED',
] as const;
...
export type ActionPayloadMap = {
  ...
  QUARTER_RESULTS_REVIEWED: Record<string, never>;
  QUARTER_RELIC_CHOSEN: { relicId: ContentId };
  QUARTER_RELICS_SKIPPED: Record<string, never>;
  QUARTER_STRATEGY_CHOSEN: { strategyId: ContentId };
  QUARTER_STRATEGY_SKIPPED: Record<string, never>;
